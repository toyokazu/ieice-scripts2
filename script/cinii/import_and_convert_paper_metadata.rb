...
$tsv_tran_ja = "#{$prefix}/#{config["tsv_tran_ja"]}_#{$date}.txt"
$tsv_tran_en_ja = "#{$prefix}/#{config["tsv_tran_en_ja"]}_#{$date}.txt"
$tsv_tran_en = "#{$prefix}/#{config["tsv_tran_en"]}_#{$date}.txt"
